...
El Contexto es Clave: Incluir TODA la documentación, ejemplos y advertencias necesarias.

Bucles de Validación: Proporcionar pruebas/análisis estáticos (lints) ejecutables que la IA pueda correr y corregir.

Denso en Información: Usar palabras clave y patrones de la base de código.

Éxito Progresivo: Empezar de forma simple, validar y luego mejorar.

Reglas Globales: Asegúrese de seguir todas las reglas en CLAUDE.md.
